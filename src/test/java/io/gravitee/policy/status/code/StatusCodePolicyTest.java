...
class StatusCodePolicyTest {
    ...
    void shouldNotChangeStatusWhenNoMappings() {
        ...
        io.reactivex.rxjava3.core.Completable completable = policy.onHttpResponse(ctx);
    ...
    void shouldChangeStatusWhenMappingExists() {
        ...
        Completable completable = policy.onHttpResponse(ctx);
        completable.test().assertComplete();
    ...
    void shouldChangeStatusForMultipleDifferentMappings() {
        ...
        completable = policy.onHttpResponse(ctx);
        completable.test().assertComplete();
